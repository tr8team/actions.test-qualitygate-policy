...
describe("GithubActionIO for ActionIO", function() {
  ...
  describe("getOptionalObject", function() {
    describe("with validator", function() {
      it("should return error if its not a valid JSON", async function() {
        // arrange
        const input = {
        ...
        // act
        const output = await emulateAction({
          relativePath: [...actionScripts, "io", "get_opt_object_write_debug.ts"],
          input
        }, f.emulate);
      ...
      it("should return error if the validator fails", async function() {
        ...
        // act
        const output = await emulateAction({
          relativePath: [...actionScripts, "io", "get_opt_object_write_debug_2.ts"],
          input
        }, f.emulate);
      ...
      it("should return object if its a valid object", async function() {
        ...
        // act
        const output = await emulateAction({
          relativePath: [...actionScripts, "io", "get_opt_object_write_debug_3.ts"],
          input
        }, f.emulate);
      ...
      it("should return None if its not set", async function() {
        // arrange
        const input = {};
        const expected = {
          "debug": [
        ...
        // act
        const output = await emulateAction({
          relativePath: [...actionScripts, "io", "get_opt_object_write_debug_4.ts"],
          input
        }, f.emulate);
    ...
    describe("without validator", function() {
      it("should return error if its not a valid JSON", async function() {
        ...
        // act
        const output = await emulateAction({
          relativePath: [...actionScripts, "io", "get_opt_object_write_debug_without_validator.ts"],
          input
        }, f.emulate);
      ...
      it("should return object if its a valid object", async function() {
        ...
        // act
        const output = await emulateAction({
          relativePath: [...actionScripts, "io", "get_opt_object_write_debug_without_validator_2.ts"],
          input
        }, f.emulate);
      ...
      it("should return None if its not set", async function() {
        ...
        // act
        const output = await emulateAction({
          relativePath: [...actionScripts, "io", "get_opt_object_write_debug_without_validator_3.ts"],
          input
        }, f.emulate);
